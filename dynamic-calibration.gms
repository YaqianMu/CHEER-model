...
sffelec1(sub_elec)$(wsb(sub_elec))=sffelec_BAU(t,sub_elec);
...
display China3E.modelstat, China3E.solvestat,clim,clim0,emkup,re_s;
...
display tqlabor_s0,tlabor_s0,cquota,rgdp.l,gprod.l,ret0,sffelec1,sffelec_BAU;
);
